...
final Uri userCreateByEmailApi = Uri.parse('${baseUrl}create-user-email');
final Uri userCreateToPhoneApi = Uri.parse('${baseUrl}create-user-mobile');
final Uri sendOtpToEmailApi = Uri.parse('${baseUrl}send-email');
final Uri sendOtpToPhoneApi = Uri.parse('${baseUrl}send-mobile');
final Uri verifyOtpFromEmailApi = Uri.parse('${baseUrl}verify/email');
final Uri verifyOtpFromPhoneApi = Uri.parse('${baseUrl}login');
final Uri getUserSignUpApi = Uri.parse('${baseUrl}signup');
