...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
      ...
      child: ListTile(
        ...
        onTap: () async {
          if (title == getTranslated(context, 'MY_ORDERS_LBL')) {
            ...
            _launchUrl('https://elitetiers.3chats.com/contact-us');
            // Navigator.push(
            //     context,
            //     CupertinoPageRoute(
            ...
            _launchUrl('https://elitetiers.3chats.com/terms/conditions');
            // Navigator.push(
            //     context,
            //     CupertinoPageRoute(
            //       builder: (context) => PrivacyPolicy(
          ...
          // }
            ...
            _launchUrl('https://elitetiers.3chats.com/refund/policy');
            // Navigator.push(
            //     context,
            //     CupertinoPageRoute(
            //       builder: (context) => PrivacyPolicy(
  ...
  _showDialog() async {
    ...
    await showGeneralDialog(
        barrierColor:
            Theme.of(context).colorScheme.black.withValues(alpha: 0.5),
